...
export function dateFormat(
	...
	return formatDate(normalizeDate(date), formatStr, options?.locales)
}

export type DateFormatReturn = ReturnType<typeof dateFormat>

// alias
export { dateFormat as date_format }
