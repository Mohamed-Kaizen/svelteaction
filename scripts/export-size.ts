...
async function run() {
	...
	await fs.copyFile(
		path.join(sharedPkgDist, "index.mjs"),
		path.join(sharedPkgRoot, "index.mjs")
	)
	...
	md += "> Please note this is bundle size for each individual APIs. "
	md +=
